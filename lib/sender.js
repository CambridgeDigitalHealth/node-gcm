...
var ProxyAgent = require('@camdh/https-proxy-agent');
...
Sender.prototype.send = function(message, recipient, options, callback) {
    ...
    // Disabling retries, not changing anything else
...
Sender.prototype.sendNoRetry = function(message, recipient, callback) {
    ...
    getRequestBody(message, recipient, function(err, body) {
        ...
        // Set proxy agent
        if (this.options.proxy && typeof this.options.proxy === 'object') {
            this.options.agent = new ProxyAgent({
                host: this.options.proxy.host,
                port: this.options.proxy.port,
                timeout: this.options.proxy.timeout
            });
            this.options.tunnel = false;
